...
%\end{equation}
Interestingly, this operation has a form very similar to \textbf{Self-Attention} except for the order of softmax and tensor product (with neural string-diagrams on the right):
%\begin{equation}
