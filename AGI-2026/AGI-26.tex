...
\usetikzlibrary{arrows,positioning,decorations.markings,shapes.multipart,shapes.geometric,shapes.arrows,tikzmark,calc,decorations.pathreplacing,arrows.meta}
\usepackage{tikz-cd}
...
\begin{aligned}
	...
	\\
	\alpha(\mathbf{Q,K,V}) = \text{soft}\max  \frac{\langle \mathbf{Q,K} \rangle}{\sqrt{d_k}} \mathbf{V}
	\quad
